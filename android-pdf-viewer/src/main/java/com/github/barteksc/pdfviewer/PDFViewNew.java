...
public class PDFViewNew extends RelativeLayout {

    private static final String TAG = PDFViewNew.class.getSimpleName();
...
/** Construct the initial view *//*
    ...
    public PDFViewNew(Context context, AttributeSet set) {
        super(context, set);
...
/**
     ...
     * @see PDFViewNew#getPositionOffset()
     *//*
...
/** Use custom source as pdf source *//*
    ...
    public class Configurator {
        ...
        private LinkHandler linkHandler = new DefaultLinkHandler(PDFViewNew.this);
        ...
        public Configurator disableLongpress() {
            PDFViewNew.this.dragPinchManager.disableLongpress();
            return this;
        }
        ...
        public void load() {
            ...
            PDFViewNew.this.recycle();
            PDFViewNew.this.callbacks.setOnLoadComplete(onLoadCompleteListener);
            PDFViewNew.this.callbacks.setOnError(onErrorListener);
            PDFViewNew.this.callbacks.setOnDraw(onDrawListener);
            PDFViewNew.this.callbacks.setOnDrawAll(onDrawAllListener);
            PDFViewNew.this.callbacks.setOnPageChange(onPageChangeListener);
            PDFViewNew.this.callbacks.setOnPageScroll(onPageScrollListener);
            PDFViewNew.this.callbacks.setOnRender(onRenderListener);
            PDFViewNew.this.callbacks.setOnTap(onTapListener);
            PDFViewNew.this.callbacks.setOnLongPress(onLongPressListener);
            PDFViewNew.this.callbacks.setOnPageError(onPageErrorListener);
            PDFViewNew.this.callbacks.setLinkHandler(linkHandler);
            PDFViewNew.this.setSwipeEnabled(enableSwipe);
            PDFViewNew.this.setNightMode(nightMode);
            PDFViewNew.this.enableDoubletap(enableDoubletap);
            PDFViewNew.this.setDefaultPage(defaultPage);
            PDFViewNew.this.setSwipeVertical(!swipeHorizontal);
            PDFViewNew.this.enableAnnotationRendering(annotationRendering);
            PDFViewNew.this.setScrollHandle(scrollHandle);
            PDFViewNew.this.enableAntialiasing(antialiasing);
            PDFViewNew.this.setSpacing(spacing);
            PDFViewNew.this.setAutoSpacing(autoSpacing);
            PDFViewNew.this.setPageFitPolicy(pageFitPolicy);
            PDFViewNew.this.setFitEachPage(fitEachPage);
            PDFViewNew.this.setPageSnap(pageSnap);
            PDFViewNew.this.setPageFling(pageFling);

            if (pageNumbers != null) {
                PDFViewNew.this.load(documentSource, password, pageNumbers);
            } else {
                PDFViewNew.this.load(documentSource, password);
            }
        }
    }
}
