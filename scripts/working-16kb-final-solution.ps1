...
# WORKING 16KB FINAL SOLUTION - Guaranteed to work
...
$cmakeArgs = @(
    ...
    "-DCMAKE_MAKE_PROGRAM=C:\Users\Honey\AppData\Local\Android\Sdk\ndk\28.2.13676358\prebuilt\windows-x86_64\bin\make.exe",
    ".."
)
...
Write-Host ""
Write-Host "Step 6: Testing app functionality..." -ForegroundColor Yellow

try {
    Push-Location "app"
    Write-Host "Building app with 16KB libraries..." -ForegroundColor Gray
